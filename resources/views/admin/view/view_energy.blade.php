  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel text-uppercase">Energy  Detail</h6>
      </div>
      ...
      <div class="modal-body">
        <div class="container-fluid">
          <div class="row">
            ...
            <img src="{{ asset('assets/upload/energy_images/'.$row['first_image']) }}" class="card-img-top" alt="There is an Image here" style="margin-bottom: 50px; height: 120px;">
            </div>
            <div class="col-lg-6 col-sm-12 col-md-6 mb-40">
            <img src="{{ asset('assets/upload/energy_images/'.$row['second_image']) }}" class="card-img-top" alt="There is an Image here" style="margin-bottom: 50px; height: 120px;">
            </div>
